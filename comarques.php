 ...
 */
function comarques_loadcounties() {
  ...
  $allCounties = json_decode(file_get_contents(__DIR__ . '/comarques.json'), TRUE);
 ...
 */
function comarques_civicrm_install() {
  comarques_loadcounties();
}
 ...
 */
function comarques_civicrm_enable() {
  comarques_loadcounties();
}
 ...
 */
function comarques_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  comarques_loadcounties();
}
